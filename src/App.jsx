...
function App() {
  ...
  const [urlText, setUrlText] = useState("https://github.com/mansi209aps");
  ...
  return (
    <div className='h-screen bg-blue-50 max-w-6xl mx-auto border-black'>
      ...
      <div className='p-2'>
        <h2 className='text-center m-4'>Made By 👨‍💻 <a href="https://github.com/mansi209aps/" target='_blank' className='text-blue-600'>Mansi209aps</a></h2>
